...
SCHEMA_PATH = Path('/home/irek/FoodRecommender/server/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = BinaryPaths.parse_obj({'queryEngine': {'linux-arm64-openssl-3.0.x': '/home/irek/.cache/prisma-python/binaries/4.15.0/8fbc245156db7124f997f4cecdd8d1219e360944/node_modules/prisma/query-engine-linux-arm64-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    recpies: 'actions.RECPIESActions[models.RECPIES]'
    users: 'actions.USERSActions[models.USERS]'
    user_likes_recpies: 'actions.USER_likes_RECPIESActions[models.USER_likes_RECPIES]'
    ...
    def __init__(
        ...
        *,
        ...
        self.recpies = actions.RECPIESActions[models.RECPIES](self, models.RECPIES)
        self.users = actions.USERSActions[models.USERS](self, models.USERS)
        self.user_likes_recpies = actions.USER_likes_RECPIESActions[models.USER_likes_RECPIES](self, models.USER_likes_RECPIES)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'postgresql://postgres:root@localhost:5432', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    recpies: 'RECPIESBatchActions'
    users: 'USERSBatchActions'
    user_likes_recpies: 'USER_likes_RECPIESBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.recpies = RECPIESBatchActions(self)
        self.users = USERSBatchActions(self)
        self.user_likes_recpies = USER_likes_RECPIESBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class USER_likes_RECPIESBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.USER_likes_RECPIES,
            arguments={
                'data': data,
                'include': include,
            },
